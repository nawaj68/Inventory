...
import { MessageHandler } from "src/app/shared/message.handler";
...
export class FileHandler {
  ...
  constructor(public messageService: MessageHandler) {}
    ...
    if (file != null) {
      ...
      if (
        ...
        (!this.fileOptions.acctptedTypes.split(",").includes(ext) ||
          (this.fileOptions.hasOwnProperty("maxSizeKB")
          // && this.fileOptions.maxSizeKB < size
          ))
      ) {
        this.showMessage();
        return false;
