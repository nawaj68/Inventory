...
export class SubCategoryListComponent implements OnInit {
  ...
  displayedColumns: string[] = ["subCategoryName","subCategoryCode","picture","action"];
  ...
  load(): any {
    return this.subCategoryService.getSearch(
  ...
  remove(subCategoryId: number): void {
    if (subCategoryId) {
      this.messageService.confirm().then((result) => {
        if (result.value) {
          this.subCategoryService.delete(subCategoryId).subscribe((e) => {
